...
class EducationPage {
    static educations: Education[] | null = null;
    
    static getFormattedContent(education: Education): string {
        return `
        <div class="row">
...
EducationPage.initializePage().then(() => {
    const educationContent = document.getElementById('education') as HTMLDivElement;
