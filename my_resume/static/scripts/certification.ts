...
class CertificationPage {
    static certifications: Certification[] | null = null;

    static getFormattedContent(certification: Certification): string {
...
CertificationPage.initializePage().then(() => {
    const certificationContent = document.getElementById('certification') as HTMLDivElement;
